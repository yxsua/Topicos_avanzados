...
public class EjemploEventos1ClasesInternas extends Applet implements ActionListener {
	...
	public void init() {
		System.out.println("Inicializando ejemplo con manejo de eventos en clases internas...");
		...
		// Es necesaria añadir los listeners para el registro de los eventos en consola,
		// el evento de los botones en sí se manejerá con las clases internas
				bIzdo.addActionListener(this);
				bCentral.addActionListener(this);
				bDcho.addActionListener(this);
				
		// Añadir eventos mediante clases internas
		bIzdo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				display.setText(entrada.getText());
			}
		});
		bCentral.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		bDcho.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				display.setText("");
				display.setForeground(Color.black);
			}
