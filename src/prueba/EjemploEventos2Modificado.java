...
public class EjemploEventos2Modificado extends Frame {
	
	// Declarar variables
	Button b1, b2;
	TextField tf;
	
	EjemploEventos2Modificado(String titulo) {
		...
		b1.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				...
				System.out.println("Foco en el botón 1");
			}
			
			public void mouseExited(MouseEvent e) {
				b1.setBackground(Color.white);
				System.out.println("Perdido foco en el botón 1");
			}
		});
